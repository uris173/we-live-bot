...
const uz = {
  ...
  enterFeedback: `Siz bizning xizmatimizni baholashni tugatmagansiz, sharh qoldiring yoki <i>"➡️ O'tkazib yuborish"</i> tugmasini bosib ushbu qismni o'tkazib yuboring.`,
...
const ru = {
  ...
  enterFeedback: `Вы не закончили оценку нашего сервиса, пожалуйста оставьте коментарий или пропустите эту часть нажав на кнопку <i>"➡️ Пропустить"</i>`,
